...
const ArchiveFile = ({ name, date, refresh, duration, id, delay }) => {
  ...
  return (
    !deleted && (
      <motion.div
        ...
        ${expanded ? "h-[60vh]" : "h-12"} transition-[height] duration-200 
        border-${
          !expanded
            ? "white"
            : type === "record"
      ...
      text-center justify-center items-center cursor-pointer
      '
          onClick={() => {
            expandAction();
          }}
